                                ...
                                <table class="table table-bordered" style="margin-bottom: 10px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center" width="200px">
                                            ...
                                            ?>
                                            <a class="btn btn-danger"  onclick="javasciprt: return confirm('Anda yakin akan menghapus data akun? ')"  href="<?= site_url('akun/delete/'.$akun->id)?>"><i class="fa fa-trash"></i></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
